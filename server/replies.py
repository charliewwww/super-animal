...
KEYWORDS = [
    ("sad", ["sad", "cry", "upset", "down", "傷心", "難過", "唔開心", "喊"]),
    ("tired", ["tired", "exhausted", "sleep", "累", "攰", "瞓"]),
    ("angry", ["angry", "mad", "frustrated", "嬲", "嬲爆"]),
    ("happy", ["happy", "great", "good", "開心", "高興", "好開心"]),
    ("scared", ["scared", "afraid", "worried", "anxious", "驚", "怕", "擔心"]),
    ("lonely", ["lonely", "alone", "孤單", "寂寞", "一個人"]),
    ("love", ["love", "愛", "鍾意你"]),
]


def looks_cantonese(text: str) -> bool:
    return bool(re.search(r"[\u4e00-\u9fff]", text))


def pick_comfort_reply(user_text: str) -> str:
    lower = user_text.lower()
    pool = CANTONESE if looks_cantonese(user_text) else ENGLISH
    for mood, needles in KEYWORDS:
